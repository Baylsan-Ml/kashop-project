  ...
  return (
     <Box component={'section'} sx={{textAlign:'center', display:'flex', justifyContent:'center'}} py={5}>
      ...
      <CardContent>
        ...
        sx={{ fontSize: 30, fontWeight:'bold', display:'flex', justifyContent:'center',alignItems:'center', gap:1 }}>
           +20k
        </Typography>
        <Typography variant="h5" component="div">
        </Typography>
        <Typography color='error.main' sx={{ mb: 1.5, fontWeight:'bold' }}>Viewers</Typography>
      ...
      <CardContent>
        ...
        <Typography color='error.main' sx={{ mb: 1.5, fontWeight:'bold' }}>Users</Typography>
        <Typography variant="body2">
      ...
      <CardContent>
        ...
        <Typography color='error.main' sx={{mb: 1.5, fontWeight:'bold' }}>Partners</Typography>
        <Typography variant="body2">
          {t("Partnering with leading brands and businesses worldwide.")}
        </Typography>
      </CardContent>
    </Card>
                 </Paper>
