...
export default function UpdatePassword() {
  ...
  return (
      ...
      <Typography variant='h5' 
       sx={{ textAlign: "center", textShadow: "1px 1px 1px #2a2c41", pb: 5 }}
        ...
        <Box component={'form'}  onSubmit={handleSubmit(updatePasswordForm)} bgcolor={''}
          sx={{ gap:1, width: { xs: "100%", sm: "80%", md: "50%" }, display:'flex', flexDirection:'column' }}>
          <Box sx={{
    display: "flex",
    ...
    fontWeight: "bold",
    display: { xs: "none", sm: "block" },
  }}>{t("Confirm New Password")}</Typography>
         <TextField fullWidth type="password"
          label={t('new password')}
          ...
          >
            ...
            >
              ...
              color="success" sx={{ width: { xs: "100%", sm: "auto" } }}
