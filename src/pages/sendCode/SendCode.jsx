...
export default function SendCode() {
  ...
  return (
    ...
    textShadow: '2px 2px 1px #4e090a',
  }} color='primary'>{t("Send Code")}</Typography>
      ...
      sx={{ display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', gap:1}} mt={5}>
        <TextField label="enter your email" {...register('email')} fullWidth variant="outlined"
    ...
    flexDirection: { xs: 'column', sm: 'row' },
         ...
         sx={{ boxShadow: 2}}>
          ...
          <Button fullWidth variant="contained" color='info' type="button"
          onClick={'/login'}
